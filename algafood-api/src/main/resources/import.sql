...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao) values (7, ' Maria', 6, 4, utc_timestamp, utc_timestamp);

insert into produto (id, nome, descricao, preco, ativo, restaurante_id) values (1, 'Almôndegas', 'Almôndegas para churrasco', 5000.0, true, 2)
insert into produto (id, nome, descricao, preco, ativo, restaurante_id) values (2, 'Picanha', 'Picanha bovina', 60.0, true, 1)
...
insert into grupo (id, nome) values (3, 'Funcionário');
...
insert into restaurante_forma_pagamento (restaurante_id, forma_pagamento_id) values (1, 1), (1, 2), (1, 3), (2, 3), (3, 2), (3, 3), (4, 1), (4, 2), (5, 1), (5, 2), (6, 3), (7, 3), (7, 2), (7, 1);
